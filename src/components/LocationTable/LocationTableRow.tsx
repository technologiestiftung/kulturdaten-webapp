...
const LocationTableRow: FC<LocationTableRowProps> = ({ location, fetchLocations }: LocationTableRowProps) => {
	const deleteLocation = (e: React.MouseEvent<HTMLButtonElement, MouseEvent>, identifier: string) => {
